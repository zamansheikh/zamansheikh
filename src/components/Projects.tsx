  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive campus management system that streamlines administrative tasks, enhances student-teacher communication, and provides real-time academic tracking. Built with Flutter and Firebase, it serves as a one-stop solution for educational institutions.",
      role: "Lead Developer",
    ...
    },
    {
      title: "Calcu",
      thumbnail:
        "https://images.unsplash.com/photo-1587145820266-a5951ee6f620?auto=format&fit=crop&q=80&w=1200",
      description:
